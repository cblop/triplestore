...
var o__11965__auto___15248 = (function (){var o__11965__auto__ = (function (){var o__11965__auto__ = Promise;
return goog.object.get(o__11965__auto__,"resolve").call(o__11965__auto__);
})();
return goog.object.get(o__11965__auto__,"then").call(o__11965__auto__,callback);
})();
goog.object.get(o__11965__auto___15248,"catch").call(o__11965__auto___15248,devtools.async.rethrow_outside_promise);
...
var G__15250_15251 = Error;
var target__11984__auto___15252 = G__15250_15251;
if(cljs.core.truth_(target__11984__auto___15252)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__15250_15251)].join('')),cljs.core.str("\n"),cljs.core.str("target__11984__auto__")].join('')));
}

goog.object.set(target__11984__auto___15252,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1501400725168