...
var map__15275 = top_item;
var map__15275__$1 = ((((!((map__15275 == null)))?((((map__15275.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15275.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15275):map__15275);
var file = cljs.core.get.call(null,map__15275__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15275__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15275__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e15274){var _e = e15274;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___15277 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___15277)){
var seen_errors_15278 = temp__4655__auto___15277;
if(cljs.core.truth_(seen_errors_15278.has(self))){
} else {
seen_errors_15278.add(self);

var temp__4657__auto___15279 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___15279)){
var sense_15280 = temp__4657__auto___15279;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_15280)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1501400725281