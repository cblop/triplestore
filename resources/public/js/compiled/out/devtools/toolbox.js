...
var args14987 = [];
var len__7492__auto___14993 = arguments.length;
var i__7493__auto___14994 = (0);
while(true){
if((i__7493__auto___14994 < len__7492__auto___14993)){
args14987.push((arguments[i__7493__auto___14994]));

var G__14995 = (i__7493__auto___14994 + (1));
i__7493__auto___14994 = G__14995;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox14990 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox14990 = (function (obj,header,style,tag,meta14991){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox14990.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14992,meta14991__$1){
var self__ = this;
var _14992__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox14990(self__.obj,self__.header,self__.style,self__.tag,meta14991__$1));
});

devtools.toolbox.t_devtools$toolbox14990.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14992){
var self__ = this;
var _14992__$1 = this;
return self__.meta14991;
});

devtools.toolbox.t_devtools$toolbox14990.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox14990.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox14990.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox14990.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox14990.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta14991","meta14991",1097298465,null)], null);
});

devtools.toolbox.t_devtools$toolbox14990.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox14990.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox14990";

devtools.toolbox.t_devtools$toolbox14990.cljs$lang$ctorPrWriter = (function (this__7023__auto__,writer__7024__auto__,opt__7025__auto__){
return cljs.core._write.call(null,writer__7024__auto__,"devtools.toolbox/t_devtools$toolbox14990");
});

devtools.toolbox.__GT_t_devtools$toolbox14990 = (function devtools$toolbox$__GT_t_devtools$toolbox14990(obj__$1,header__$1,style__$1,tag__$1,meta14991){
return (new devtools.toolbox.t_devtools$toolbox14990(obj__$1,header__$1,style__$1,tag__$1,meta14991));
});

}

return (new devtools.toolbox.t_devtools$toolbox14990(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1501400724885