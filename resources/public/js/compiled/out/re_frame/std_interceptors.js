...
var vec__11111_11114 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_11115 = cljs.core.nth.call(null,vec__11111_11114,(0),null);
var only_after_11116 = cljs.core.nth.call(null,vec__11111_11114,(1),null);
var db_changed_QMARK__11117 = (cljs.core.some_QMARK_.call(null,only_before_11115)) || (cljs.core.some_QMARK_.call(null,only_after_11116));
if(db_changed_QMARK__11117){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_11115);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_11116);
...
var map__11124 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__11124__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__11124__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__11132 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__11132__$1;
var event = cljs.core.get.call(null,map__11132__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7492__auto___11135 = arguments.length;
var i__7493__auto___11136 = (0);
while(true){
if((i__7493__auto___11136 < len__7492__auto___11135)){
args__7499__auto__.push((arguments[i__7493__auto___11136]));

var G__11137 = (i__7493__auto___11136 + (1));
i__7493__auto___11136 = G__11137;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq11134){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11134));
});
...
var args__7499__auto__ = [];
var len__7492__auto___11143 = arguments.length;
var i__7493__auto___11144 = (0);
while(true){
if((i__7493__auto___11144 < len__7492__auto___11143)){
args__7499__auto__.push((arguments[i__7493__auto___11144]));

var G__11145 = (i__7493__auto___11144 + (1));
i__7493__auto___11144 = G__11145;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__11138_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__11139_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__11139_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq11140){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__11141,G__11142,seq11140__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1501400719058