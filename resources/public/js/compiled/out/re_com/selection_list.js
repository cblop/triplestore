...
var args10323 = [];
var len__7492__auto___10326 = arguments.length;
var i__7493__auto___10327 = (0);
while(true){
if((i__7493__auto___10327 < len__7492__auto___10326)){
args10323.push((arguments[i__7493__auto___10327]));

var G__10328 = (i__7493__auto___10327 + (1));
i__7493__auto___10327 = G__10328;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__6405__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__6405__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__6405__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__10333){
var map__10336 = p__10333;
var map__10336__$1 = ((((!((map__10336 == null)))?((((map__10336.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10336.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10336):map__10336);
var args = map__10336__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__10336__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__10336,map__10336__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__10330_SHARP_){
return item_renderer.call(null,p1__10330_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__10336,map__10336__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__10336,map__10336__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__10331_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__10331_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__10336,map__10336__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__10336,map__10336__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__10332_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__10332_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__10336,map__10336__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__7492__auto___10345 = arguments.length;
var i__7493__auto___10346 = (0);
while(true){
if((i__7493__auto___10346 < len__7492__auto___10345)){
args__7499__auto__.push((arguments[i__7493__auto___10346]));

var G__10347 = (i__7493__auto___10346 + (1));
i__7493__auto___10346 = G__10347;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__7500__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__10339){
var map__10340 = p__10339;
...
var args = map__10340__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__10340,map__10340__$1,args){
return (function() { 
var G__10348__delegate = function (p__10342){
...
while (G__10349__i < G__10349__a.length) {G__10349__a[G__10349__i] = arguments[G__10349__i + 0]; ++G__10349__i;}
  p__10342 = new cljs.core.IndexedSeq(G__10349__a,0);
} 
return G__10348__delegate.call(this,p__10342);};
G__10348.cljs$lang$maxFixedArity = 0;
G__10348.cljs$lang$applyTo = (function (arglist__10350){
var p__10342 = cljs.core.seq(arglist__10350);
return G__10348__delegate(p__10342);
});
G__10348.cljs$core$IFn$_invoke$arity$variadic = G__10348__delegate;
return G__10348;
})()
;
;})(map__10340,map__10340__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq10338){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10338));
});


//# sourceMappingURL=selection_list.js.map?rel=1501400717981